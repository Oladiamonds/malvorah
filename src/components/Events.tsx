const eventTypes = [
  {
    ...
    description: "Intensive workshops teaching essential digital skills to underserved communities.",
    icon: (
  ...
  },
  {
    ...
    description: "Networking events that bring learners, leaders, and changemakers together.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Expert-led sessions on career growth, product management, and industry trends.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Structured cohort-based programmes to fast-track your career in product.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center rounded-full bg-blue-500 px-6 py-3 text-sm font-semibold text-white hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/25"
              >
                Reserve Your Seat
              </a>
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition-all"
              >
                Learn More
              </a>
            </div>
            ...
            {eventTypes.map((event) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-navy-900 text-white flex items-center justify-center shrink-0 group-hover:bg-blue-500 transition-colors">
                    {event.icon}
                  </div>
