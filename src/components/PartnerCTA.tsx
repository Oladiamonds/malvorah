  ...
  return (
    <section className="py-24 bg-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative rounded-3xl bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 overflow-hidden shadow-2xl shadow-navy-900/30">
          {/* Decorative elements */}
          ...
          <div className="relative px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#contact"
                className="inline-flex items-center justify-center rounded-full bg-white px-8 py-4 text-base font-semibold text-navy-900 hover:bg-slate-100 transition-all shadow-lg shadow-white/10 hover:-translate-y-0.5"
              >
